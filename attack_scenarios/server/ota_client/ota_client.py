...
def get_update_file(update_file_name):
    # 서버의 URL
    url = f"https://210.123.37.95:5000/get_update?update_file_name={update_file_name}"

    # HTTPS 요청 보내기
    response = requests.get(url, verify=False, stream=True)  # 스트리밍 모드로 요청
...
if __name__ == "__main__":
    ...
    mqtt_client(broker_address=broker_address, port = 12011)
